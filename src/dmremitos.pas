...
type
  ...
  TDM_Remitos = class(TDataModule)
    ...
    qLevantarRemitoEquiposIDREMITOEQUIPO: TStringField;
    qLevantarRemitoEquiposLXNOMBRE: TStringField;
    qLevantarRemitoEquiposLXNRO: TLongintField;
    qLevantarRemitoEquiposLXTIPOEQUIPO: TStringField;
    qLevantarRemitoEquiposREFEQUIPO: TStringField;
    qLevantarRemitoEquiposREFREMITO: TStringField;
    qLevantarRemitoReclamoBATENDIDO: TSmallintField;
    qLevantarRemitoReclamoBVISIBLE: TSmallintField;
    qLevantarRemitoReclamoCSOLICITANTE: TStringField;
    qLevantarRemitoReclamoFATENDIDO: TDateField;
    qLevantarRemitoReclamoFFECHA: TDateField;
    qLevantarRemitoReclamoFHORA: TTimeField;
    qLevantarRemitoReclamoIDRECLAMO: TStringField;
    qLevantarRemitoReclamoIDRECLAMOREMITO: TStringField;
    qLevantarRemitoReclamoNNRO: TLongintField;
    qLevantarRemitoReclamoREFCLIENTE: TStringField;
    qLevantarRemitoReclamoREFMEDIO: TLongintField;
    qLevantarRemitoReclamoREFORDENTRABAJO: TStringField;
    qLevantarRemitoReclamoREFRECLAMO: TStringField;
    qLevantarRemitoReclamoREFREMITO: TStringField;
    qLevantarRemitoReclamoREFTECNICOATENDIO: TLongintField;
    qLevantarRemitoReclamoTXDETALLES: TStringField;
    qLevantarRemitoReclamoTXINFORMETECNICO: TStringField;
    qLevantarRemitoReclamoTXOBSERVACIONES: TStringField;
    qLevantarRemitoTecnicos: TZQuery;
    qLevantarRemitoReclamo: TZQuery;
    qLevantarRemitoTecnicosIDREMITOTECNICO: TStringField;
    qLevantarRemitoTecnicosLXNOMBRETECNICO: TStringField;
    qLevantarRemitoTecnicosREFREMITO: TStringField;
    qLevantarRemitoTecnicosREFTECNICO: TLongintField;
    qListaRemitos: TZQuery;
    qListaRemitosBFACTURADO: TSmallintField;
    qListaRemitosBPRESENTADO: TSmallintField;
    qListaRemitosBSINCARGO: TSmallintField;
    qListaRemitosBVISIBLE: TSmallintField;
    qListaRemitosCCODIGO: TStringField;
    qListaRemitosCNOMBRE: TStringField;
    qListaRemitosFFECHA: TDateField;
    qListaRemitosIDREMITO: TStringField;
    qListaRemitosNREMITO: TLongintField;
    qListaRemitosREFCLIENTE: TStringField;
    qtugMotivosRemito: TZQuery;
    qtugMotivosRemitoBVISIBLE: TSmallintField;
    qtugMotivosRemitoIDMOTIVOREMITO: TLongintField;
    qtugMotivosRemitoMOTIVOREMITO: TStringField;
    tbRemitos: TRxMemoryData;
    tbRemitosbFacturado: TLongintField;
    tbRemitosbFacturar: TLongintField;
    tbRemitosbPresentado: TLongintField;
    tbRemitosbSinCargo: TLongintField;
    tbRemitosbVisible: TLongintField;
    tbRemitosDEL: TZQuery;
    tbRemitosfFecha: TDateTimeField;
    tbRemitosidRemito: TStringField;
    tbRemitosINS: TZQuery;
    tbRemitoslxMotivo: TStringField;
    tbRemitosnRemito: TLongintField;
    tbRemitosrefCliente: TStringField;
    tbRemitosrefFactura: TStringField;
    tbRemitosrefMotivo: TLongintField;
    tbRemitosrefOrdenTrabajo: TStringField;
    tbRemitosSEL: TZQuery;
    tbRemitosSELBFACTURADO: TSmallintField;
    tbRemitosSELBFACTURAR: TSmallintField;
    tbRemitosSELBPRESENTADO: TSmallintField;
    tbRemitosSELBSINCARGO: TSmallintField;
    tbRemitosSELBVISIBLE: TSmallintField;
    tbRemitosSELFFECHA: TDateField;
    tbRemitosSELIDREMITO: TStringField;
    tbRemitosSELNREMITO: TLongintField;
    tbRemitosSELREFCLIENTE: TStringField;
    tbRemitosSELREFFACTURA: TStringField;
    tbRemitosSELREFMOTIVO: TLongintField;
    tbRemitosSELREFORDENTRABAJO: TStringField;
    tbRemitosSELTXDETALLES: TStringField;
    tbRemitostxDetalles: TStringField;
    tbRemitosUPD: TZQuery;
    trRemitoEquipos: TRxMemoryData;
    trRemitoEquiposidRemitoEquipo: TStringField;
    trRemitoEquiposlxNombre: TStringField;
    trRemitoEquiposlxNro: TLongintField;
    trRemitoEquiposlxTipoEquipo: TStringField;
    trRemitoEquiposrefEquipo: TStringField;
    trRemitoEquiposrefRemito: TStringField;
    trRemitoEquiposSELIDREMITOEQUIPO: TStringField;
    trRemitoEquiposSELREFEQUIPO: TStringField;
    trRemitoEquiposSELREFREMITO: TStringField;
    trRemitoTecnicos: TRxMemoryData;
    trRemitoEquiposDEL: TZQuery;
    trRemitoTecnicosDEL: TZQuery;
    trRemitoEquiposINS: TZQuery;
    trRemitoTecnicosidRemitoTecnico: TStringField;
    trRemitoTecnicosINS: TZQuery;
    trRemitoEquiposSEL: TZQuery;
    trRemitoTecnicoslxNombreTecnico: TStringField;
    trRemitoTecnicosrefRemito: TStringField;
    trRemitoTecnicosrefTecnico: TLongintField;
    trRemitoTecnicosSEL: TZQuery;
    trRemitoEquiposUPD: TZQuery;
    trRemitoTecnicosSELIDREMITOTECNICO: TStringField;
    trRemitoTecnicosSELREFREMITO: TStringField;
    trRemitoTecnicosSELREFTECNICO: TLongintField;
